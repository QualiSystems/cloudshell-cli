...
from cloudshell.cli.service.error_map import Error, ErrorMap
...
class TestExpectSession(TestCase):
    ...
    def test_hardware_expect_error_map_call(
        ...
        normalize_buffer.return_value = expected_string
        error_map = ErrorMap(
            errors=[Error(pattern=expected_string, error="test_error")]
        )
    ...
    def test_hardware_expect_error_map_call_with_exception(
        ...
        normalize_buffer.return_value = expected_string
        error_map = ErrorMap(
            errors=[Error(pattern=expected_string, error=TestException("test_error"))]
        )
