...
class TestExpectSession(TestCase):
    ...
    def test_init_attributes(self, normalize_buffer, loops_detected):
        mandatory_attributes = ['_loop_detector_max_combination_length', '_empty_loop_timeout', '_clear_buffer_timeout',
                                '_reconnect_timeout', '_active', '_loop_detector_max_action_loops', '_max_loop_retries',
                                '_timeout', '_new_line']
    ...
    def test_send_line(self, normalize_buffer, loops_detected):
        ...
        self._send.assert_called_once_with(command + self._instance._new_line, self._logger)
    ...
    def test_hardware_expect_clear_buffer_calls(self, clear_buffer, receive_all, send_line, normalize_buffer,
        ...
        mock_calls = [call(self._instance._clear_buffer_timeout, self._logger),
...
class TestActionLoopDetector(TestCase):
    def setUp(self):
        ...
        self._instance = ActionLoopDetector(self._max_loops, self._max_combination_length)
