...
class TestTelnetSession(TestCase):
    ...
    @patch('cloudshell.cli.session.session.AbstractSession')
    ...
    def test_intialize_session(self, telnet_lib):
        ...
        hostname = "localhost"
        self._instance = TelnetSession(hostname, self._username, 'incorrect_password', port=self._port,
                                       on_session_start=self._on_session_start)
    ...
    def test_connect_actions(self):
        ...
        self._instance = TelnetSession(hostname, self._username, 'password', port=self._port,
