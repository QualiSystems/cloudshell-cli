...
from cloudshell.cli.service.action_map import Action, ActionMap
...
class TestAction(unittest.TestCase):
    ...
    def test_call(self):
        """Check will call callback function with session and logger as attributes."""
        # act
...
class TestActionMap(unittest.TestCase):
    def setUp(self):
        ...
        self.callback = mock.MagicMock()
        self.actions = [
            Action(pattern="[Pp]attern 1", callback=self.callback),
    ...
    def test_extend(self):
        ...
        default_actions = [
            Action(pattern="[Pp]attern 4", callback=self.callback),
        ...
        default_action_map.matched_patterns = {
            default_action1.pattern,
        ...
        # verify
        self.assertEqual(
            self.action_map.matched_patterns,
            {default_action1.pattern, default_action2.pattern, action3.pattern},
        )

        self.assertEqual(
            self.action_map.actions, [action1, action2, action3, default_action1]
        )
    ...
    def test_extend_with_override_true(self):
        ...
        self.assertEqual(
            ...
            [action1, default_action2, action3, default_action1],
        )
