...
class TestCommandMode(TestCase):
    ...
    def test_init(self):
        attributes = ['_enter_error_map', '_prompt', '_enter_command', '_exit_error_map', '_exit_command',
                      'child_nodes',
                      '_exit_action_map', '_enter_actions', 'parent_node', '_enter_action_map', '_use_exact_prompt',
                      '_exact_prompt']
